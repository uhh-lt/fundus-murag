...
class OpenAIImageAnalysisAssistant(BaseImageAnalysisAssistant, metaclass=SingletonMeta):
    def __init__(self, model_name: str | None = None):
        ...
        self._vqa_model: ModelConfig = self._build_model_config(
            self._default_model_name, "vqa"
        )
        self._ic_model: ModelConfig = self._build_model_config(
            self._default_model_name, "ic"
        )
